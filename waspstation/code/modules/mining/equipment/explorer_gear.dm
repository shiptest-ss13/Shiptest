/obj/item/clothing/suit/hooded/survivor
	name = "survivor suit"
	desc = "A ragged makeshift suit resembling the explorer suit. It's been repaired so many times it's hard to tell if it's more suit or patch."
	icon = 'waspstation/icons/obj/clothing/suits.dmi'
	lefthand_file = 'waspstation/icons/mob/inhands/clothing/lefthand.dmi'
	righthand_file = 'waspstation/icons/mob/inhands/clothing/righthand.dmi'
	...
	armor = list("melee" = 5, "bullet" = 0, "laser" = 0, "energy" = 5, "bomb" = 20, "bio" = 100, "rad" = 20, "fire" = 30, "acid" = 30)
