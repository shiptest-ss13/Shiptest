...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector:
      '.alert, .minorannounce, .syndradio, .centcomradio, .aiprivradio, .emrgradio, .pirradio,  .clipradio, .irmgradio, .pgfradio, .mwradio, .radio, .deptradio, .binarysay, .newscaster, .resonate',
  },
  {
