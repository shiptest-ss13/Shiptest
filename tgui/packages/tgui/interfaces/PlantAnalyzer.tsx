...
export const PlantAnalyzer = (props, context) => {
  const { act, data } = useBackend<CoolData>(context);
        ...
        {seed.name ? (
          <Section title={seed.name}>
            <Stack vertical fill>
              ...
              <Stack.Item>
                Weed Rate:{' '}
                <AnimatedNumber value={seed.weed_rate}></AnimatedNumber>
              </Stack.Item>
              <Stack.Item>
                Weed Chance:{' '}
        ...
        {product.name ? (
          <Section title={product.name}>
            <Stack vertical fill>
              ...
              {product.juice_results && product.juice_results.length > 0 && (
                <Section title="Juice Results">
                  {product.juice_results.map((result, index) => (
