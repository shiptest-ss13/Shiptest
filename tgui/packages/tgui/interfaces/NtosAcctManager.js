...
export const NtosAcctManager = (props, context) => {
  return (
    <NtosWindow width={550} height={620} resizable>
...
export const NtosBankAcctManagerContent = (props, context) => {
  ...
  const { authed, jobs = [], accounts = [] } = data;
  ...
  const items =
    (searchText.length > 0 && accounts.filter(holderSearch)) || accounts;
        ...
        >
          <Table>
            <Table.Row header>
              ...
              <Table.Cell>Paycheck Grade</Table.Cell>
