/datum/map_generator/cave_generator/whitesands
	...
	mob_spawn_list = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast/random = 50, /obj/structure/spawner/lavaland/goliath = 6, \
		/mob/living/simple_animal/hostile/asteroid/basilisk/whitesands = 40, /obj/structure/spawner/lavaland/whitesandsbasilisk = 6, \
	...
	flora_spawn_list = list(/obj/structure/flora/ash/leaf_shroom = 4 , /obj/structure/flora/ash/cap_shroom = 4 , /obj/structure/flora/ash/stem_shroom = 4 , /obj/structure/flora/ash/cacti = 2, /obj/structure/flora/ash/tall_shroom = 4, /obj/structure/flora/ash/fireblossom = 2, /obj/structure/flora/ash/puce = 1)
