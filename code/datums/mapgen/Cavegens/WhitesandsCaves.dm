/datum/map_generator/cave_generator/whitesands
	...
	mob_spawn_list = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast/random = 40, /obj/structure/spawner/lavaland/goliath = 6, \
		/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/whitesands = 50, /obj/structure/spawner/lavaland = 6, \
