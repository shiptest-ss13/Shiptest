/datum/map_generator/cave_generator/icemoon
	...
	mob_spawn_list = list(
		/mob/living/simple_animal/hostile/asteroid/wolf = 50, /obj/structure/spawner/ice_moon = 3,
		/mob/living/simple_animal/hostile/asteroid/polarbear = 50, /obj/structure/spawner/ice_moon/polarbear = 3,
		/mob/living/simple_animal/hostile/asteroid/hivelord/legion/snow = 50, /mob/living/simple_animal/hostile/asteroid/goldgrub = 10,
		/mob/living/simple_animal/hostile/asteroid/ice_demon = 20, /obj/structure/spawner/ice_moon/demonic_portal = 6,
		/mob/living/simple_animal/hostile/asteroid/ice_whelp = 20, /obj/structure/spawner/ice_moon/demonic_portal/ice_whelp = 6,
...
/datum/map_generator/cave_generator/icemoon/surface
	...
	mob_spawn_chance = 8//danger zone, highway to the danger zone
	birth_limit = 5
	death_limit = 4
