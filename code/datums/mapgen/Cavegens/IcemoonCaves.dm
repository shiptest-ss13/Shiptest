/datum/map_generator/cave_generator/icemoon
	...
	mob_spawn_list = list(
		...
		/mob/living/simple_animal/hostile/asteroid/polarbear/random = 50, /obj/structure/spawner/ice_moon/polarbear = 3,
		/mob/living/simple_animal/hostile/asteroid/hivelord/legion/snow = 50, /mob/living/simple_animal/hostile/asteroid/goldgrub = 10,
		/mob/living/simple_animal/hostile/asteroid/ice_demon = 20, /obj/structure/spawner/ice_moon/demonic_portal = 7,
