...
/datum/biome/jungle
	open_turf_types = list(/turf/open/floor/plating/planetary/grass/jungle/lit = 1)
...
/datum/biome/jungle/dense
	...
	open_turf_types = list(/turf/open/floor/plating/planetary/grass/jungle/lit = 1, /turf/open/floor/plating/planetary/dirt/jungle/dark/lit = 9)
	flora_spawn_list = list(
		/obj/structure/flora/grass/jungle = 1,
		/obj/structure/flora/grass/jungle/b = 1,
...
/datum/biome/mudlands
	open_turf_types = list(/turf/open/floor/plating/planetary/dirt/jungle/dark/lit = 1)
	flora_spawn_list = list(
		/obj/structure/flora/grass/jungle = 1,
		/obj/structure/flora/grass/jungle/b = 1,
		/obj/structure/flora/rock/jungle = 1,
...
/datum/biome/cave/jungle
	open_turf_types = list(/turf/open/floor/plating/planetary/dirt/jungle = 10, /turf/open/floor/plating/planetary/dirt/jungle/dark = 10)
...
/datum/biome/cave/jungle/dirt
	open_turf_types = list(/turf/open/floor/plating/planetary/dirt/jungle/wasteland = 1)
	flora_spawn_list = list(
		/obj/structure/flora/junglebush = 1,
		/obj/structure/flora/junglebush/b = 1,
		/obj/structure/flora/junglebush/c = 1,
...
/datum/biome/cave/lush
	open_turf_types = list(/turf/open/floor/plating/planetary/grass/jungle = 1)
	closed_turf_types = list(/turf/closed/mineral/random/jungle = 1)
	flora_spawn_chance = 50
	flora_spawn_list = list(
