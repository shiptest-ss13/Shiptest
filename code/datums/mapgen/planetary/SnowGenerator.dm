...
/datum/biome/iceberg
	...
	feature_spawn_list = list(
		/obj/effect/spawner/lootdrop/anomaly = 22,
		/obj/effect/spawner/lootdrop/anomaly/big = 1,
		/obj/structure/spawner/ice_moon/demonic_portal/low_threat = 40,
		...
		/obj/structure/spawner/ice_moon/demonic_portal/extreme_threat = 5
	)
...
/datum/biome/cave/snow
	...
	feature_spawn_list = list(
		/obj/structure/spawner/ice_moon/demonic_portal/low_threat = 8,
		/obj/structure/spawner/ice_moon/demonic_portal/medium_threat = 5,
		/obj/structure/spawner/ice_moon/demonic_portal/high_threat = 2,
		/obj/structure/spawner/ice_moon = 3,
		/obj/structure/spawner/ice_moon/polarbear = 3,
		/obj/effect/spawner/lootdrop/anomaly = 1
	)
