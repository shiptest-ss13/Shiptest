...
/datum/biome/snow
	open_turf_types = list(
		/turf/open/floor/planetary/snow/iceplanet/lit = 25
	)
...
/datum/biome/snow/thawed
	open_turf_types = list(
		/turf/open/floor/planetary/iceplanet/lit = 1
	)
...
/datum/biome/arctic
	open_turf_types = list(
		/turf/open/floor/planetary/snow/iceplanet/lit = 1
	)
	feature_spawn_chance = 0.1
	feature_spawn_list = list(
		/obj/structure/spawner/ice_moon = 3,
...
/datum/biome/iceberg
	open_turf_types = list(
		/turf/open/floor/planetary/iceplanet/iceberg/lit = 6,
		/turf/open/floor/planetary/ice/iceplanet/lit = 1,
...
/datum/biome/plasma
	open_turf_types = list(
		/turf/open/floor/planetary/lava/plasma/iceplanet = 5,
		/turf/open/floor/planetary/iceplanet/smooth = 1
	)

/datum/biome/cave/snow
	open_turf_types = list(
		/turf/open/floor/planetary/iceplanet = 1
	)
...
/datum/biome/cave/snow/thawed
	open_turf_types = list(
		/turf/open/floor/planetary/iceplanet/cracked = 1
	)
	closed_turf_types = list(
		/turf/closed/mineral/random/snow = 1
	)
...
/datum/biome/cave/snow/ice
	open_turf_types = list(
		/turf/open/floor/planetary/iceplanet = 20,
		/turf/open/floor/planetary/ice/iceplanet = 3
	)
	closed_turf_types = list(
		/turf/closed/mineral/random/snow = 1
	)
...
/datum/biome/cave/volcanic/lava/plasma
	open_turf_types = list(
		/turf/open/floor/planetary/lava/plasma/iceplanet = 7,
		/turf/open/floor/planetary/iceplanet/smooth = 1
	)
