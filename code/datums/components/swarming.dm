...
/datum/component/swarming/proc/join_swarm(datum/source, atom/movable/AM, atom/old_loc, list/atom/old_locs)
	SIGNAL_HANDLER
...
/datum/component/swarming/proc/leave_swarm(datum/source, atom/movable/AM, direction)
	SIGNAL_HANDLER
