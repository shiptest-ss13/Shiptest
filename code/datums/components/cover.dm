/datum/component/cover
	...
	var/continuos_cover = FALSE

/datum/component/cover/Initialize(_blocking, _pass_rate, _block_dir)
	. = ..()
...
/datum/component/cover/proc/update_cover(obj/blocker, blocking, pass_rate)
	return
