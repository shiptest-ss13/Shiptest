...
/datum/component/chasm/proc/is_safe()
	...
	var/static/list/chasm_safeties_typecache = typecacheof(list(/obj/structure/lattice, /obj/structure/stone_tile, /obj/structure/lattice/catwalk, /obj/structure/catwalk ))
