...
/datum/component/nanites/Initialize(datum/research_web/linked_techweb, amount = 100, cloud = 0)
...
/datum/component/nanites/proc/add_research()
	...
	if(host_mob.stat == DEAD)
		research_value *= 0.75
	linked_techweb?.add_points(TECHWEB_POINT_TYPE_NANITES, research_value)
