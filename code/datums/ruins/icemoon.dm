...
/datum/map_template/ruin/major/icemoon/slimerancher //Shiptest edit
	name = "Slime Ranch"
	id = "slimerancher"
...
/datum/map_template/ruin/major/icemoon/mining_site
	name = "Mining Site"
	id = "miningsite"
