...
/datum/map_template/ruin/icemoon/crash_camp
	name = "Crashed research supplies transport"
	id = "crash_camp"
	description = "A crashed small transport formerly tasked with ferrying personal and equipment to a SolGov research facility. The survivors seem to have gone insane."
	suffix = "icemoon_surface_crash_camp.dmm"