...
/datum/quirk/drunkhealing/on_process(delta_time)
	...
	switch(C.drunkenness)
		if (6 to 40)
			C.adjustBruteLoss(-0.1*delta_time, FALSE, FALSE, BODYTYPE_ORGANIC)
			C.adjustFireLoss(-0.05*delta_time, FALSE, FALSE, BODYTYPE_ORGANIC)
		if (41 to 60)
			C.adjustBruteLoss(-0.4*delta_time, FALSE, FALSE, BODYTYPE_ORGANIC)
			C.adjustFireLoss(-0.2*delta_time, FALSE, FALSE, BODYTYPE_ORGANIC)
		if (61 to INFINITY)
			C.adjustBruteLoss(-0.8*delta_time, FALSE, FALSE, BODYTYPE_ORGANIC)
			C.adjustFireLoss(-0.4*delta_time, FALSE, FALSE, BODYTYPE_ORGANIC)
