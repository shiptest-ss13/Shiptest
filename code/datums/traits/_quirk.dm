...
/datum/quirk
	...
	var/list/species_lock //List of id-based locks for species, set "type" = "allowed" to lock the species not on the list, set "type" = "blocked" to lock the species on the list, then add the species ids to the list.
