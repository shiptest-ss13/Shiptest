...
/datum/action/item_action/toggle_radio/Trigger(trigger_flags)
...
/datum/action/item_action/activate_suit_injector/Trigger(trigger_flags)
...
/datum/action/item_action/toggle_helmet_mode/Trigger(trigger_flags)
...
/datum/action/item_action/adjust_earmuffs/Trigger(trigger_flags)
...
/// For signal calling
/* We haven't implemented the signals yet
...
/datum/action/item_action/activate_lanternbang/Trigger(trigger_flags)
