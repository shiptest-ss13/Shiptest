...
/datum/disease/heart_failure/stage_act(seconds_per_tick, times_fired)
	...
	switch(stage)
		...
		if(5)
			...
			affected_mob.reagents.add_reagent(/datum/reagent/medicine/penthrite, 3) // To give the victim a final chance to shock their heart before losing consciousness
			cure()
			return FALSE
