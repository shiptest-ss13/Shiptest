...
/datum/controller/subsystem/statpanels/fire(resumed = FALSE)
	if (!resumed)
		...
		global_data = list(
			...
			"\n",
			"Current Outpost: [SSticker.round_start_timeofday ? SSovermap.get_outpost(SSovermap.tracked_star_systems[1]) : "The round hasn't started yet!"]",
			"Outpost Location: [SSticker.round_start_timeofday ? "[SSovermap.get_outpost_coords(SSovermap.tracked_star_systems[1])] - [SSovermap.tracked_star_systems[1]]" : "The round hasn't started yet!"]",
