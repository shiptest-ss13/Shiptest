...
/datum/controller/subsystem/statpanels/fire(resumed = FALSE)
	if (!resumed)
		...
		global_data = list(
			...
			"\n",
			"Primary Outpost: [SSticker.round_start_timeofday ? SSovermap.get_outpost(SSovermap.tracked_star_systems[1]) : "The round hasn't started yet!"]",
			"Secondary Outpost: [SSticker.round_start_timeofday ? SSovermap.get_outpost(SSovermap.tracked_star_systems[3]) : "The round hasn't started yet!"]",
