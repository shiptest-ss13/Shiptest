...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_SOLGOV = FREQ_SOLGOV,		// Wasp Edit - SolGov Rep
	RADIO_CHANNEL_WIDEBAND = FREQ_WIDEBAND,		// Wasp Edit - Overmap
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SOLGOV]" = RADIO_CHANNEL_SOLGOV,		// Wasp Edit - SolGov Rep
	"[FREQ_WIDEBAND]" = RADIO_CHANNEL_WIDEBAND,		// Wasp Edit - SolGov Rep
