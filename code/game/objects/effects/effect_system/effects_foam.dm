...
/obj/effect/particle_effect/foam/firefighting/process(delta_time)
	..()
...
/obj/effect/particle_effect/foam/antirad/process(delta_time)
	..()
...
/obj/effect/particle_effect/foam/process(delta_time)
	lifetime--
	if(lifetime < 1)
		kill_foam()
		return
