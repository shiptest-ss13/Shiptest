...
/obj/structure/sign/poster/retro/radio
	name = "Radio"
	desc = "A poster advertising one of Nanotrasen's earliest products, a radio. One of its main selling points was a integrated OS and two automatic translation for Galactic Common, and Draconic, which made it a smash hit. This thing is ancient."
