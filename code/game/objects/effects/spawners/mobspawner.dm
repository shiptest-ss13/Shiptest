...
/obj/effect/spawner/random/hermit
	name = "hermit spawner"
	loot = list(
		/mob/living/carbon/human/ai_boarder/hermit/survivor = 50,
		/mob/living/carbon/human/ai_boarder/hermit/hunter = 35,
		/mob/living/carbon/human/ai_boarder/hermit/gunslinger = 10,
