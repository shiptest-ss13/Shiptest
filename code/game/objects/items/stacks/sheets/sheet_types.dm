...
GLOBAL_LIST_INIT(cardboard_recipes, list (														\
	...
	new/datum/stack_recipe_list("fancy boxes", list(
		...
		new /datum/stack_recipe("shoal-pockets box", /obj/item/storage/box/shoalpockets),			\
		new /datum/stack_recipe("shoal-pockets spicy box", /obj/item/storage/box/shoalpockets/shoalpocketspicy),			\
		new /datum/stack_recipe("shoal-pockets teriyaki box", /obj/item/storage/box/shoalpockets/shoalpocketteriyaki),		\
		new /datum/stack_recipe("shoal-pockets pizza box", /obj/item/storage/box/shoalpockets/shoalpocketpizza),			\
		new /datum/stack_recipe("shoal-pockets berry box", /obj/item/storage/box/shoalpockets/shoalpocketberry),			\
