...
/obj/effect/collapsing_demonic_portal/proc/drop_loot()
	...
	switch(loot)
		...
		if(5)
			...
			new /mob/living/simple_animal/hostile/netherworld/blankbody(loc)
			new /mob/living/simple_animal/hostile/netherworld/migo(loc)
			new /turf/open/floor/engine(loc)
		if(6)
		...
		if(11)
			...
			new /turf/open/floor/plasteel/rockvault(loc)
		if(12)
			...
			new /mob/living/simple_animal/hostile/construct/wraith(loc)
			new /mob/living/simple_animal/hostile/construct/juggernaut(loc)
		...
		if(19)
			...
			new /mob/living/simple_animal/hostile/skeleton/plasmaminer/jackhammer(loc)
			new /turf/open/floor/mineral/plasma(loc)
		if(20)
			new /obj/effect/rend(loc)
			...
			new /turf/open/floor/plasteel/kitchen_coldroom(loc)
		if(21)
			new /mob/living/simple_animal/hostile/big_legion(loc)
			new /obj/item/organ/tongue/bone(loc)
		...
		if(27)
			...
			new /obj/effect/temp_visual/fire(loc)
			new /turf/open/floor/bronze(loc)
		if(28)
		...
		if(32)
			...
			new /obj/item/camera/rewind(loc)
