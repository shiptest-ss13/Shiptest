...
/obj/structure/fluff/bsdrive
	...
	desc = "awawawaw"
	icon = 'placeholder_64x64.dmi'
	icon_state = "drive"
	density = TRUE
	anchored = TRUE

/obj/structure/fluff/gunmount
	name = "gun mount placeholder"
	desc = "awawawaw"
	icon = 'vls.dmi'
	icon_state = "port"
	anchored = TRUE
...
/obj/structure/fluff/deck_turret
	name = "deck gun placeholder"
	desc = "deck_turret"
	icon = 'deck_turret.dmi'
...
/obj/effect/turf_decal/industrial/floor_door
	name = "floor door"
	color = null
	icon = 'decoration_hatch.dmi'
	icon_state = "door_plating"

/obj/effect/turf_decal/industrial/floor_door/corner
	name = "floor door"
	icon_state = "door_plating_corner"

/obj/effect/turf_decal/industrial/floor_door/hatch
	name = "floor door"
	icon_state = "door_hatch"

/obj/effect/turf_decal/industrial/floor_door/lights
	name = "floor door"
	icon_state = "door_lights"
