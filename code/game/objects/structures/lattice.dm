/obj/structure/lattice
	name = "lattice"
	desc = "A lightweight support lattice. Holding things together since the dawn of the industrial age, you can always trust a little metal to hold the world together."
