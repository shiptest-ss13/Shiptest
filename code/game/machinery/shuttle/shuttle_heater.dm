...
/obj/machinery/atmospherics/components/unary/shuttle/heater/process_atmos(delta_time)
	if(!use_tank)
		update_parents()
...
/obj/machinery/atmospherics/components/unary/shuttle/fire_heater/process_atmos(delta_time)
