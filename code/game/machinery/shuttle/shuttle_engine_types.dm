...
/obj/machinery/power/shuttle/engine/fueled/burn_engine(percentage = 100, delta_time)
	..()
	...
	if(heat_creation)
		heat_engine()
	var/to_use = fuel_use * (percentage / 100) * delta_time
...
/obj/machinery/power/shuttle/engine/fire/burn_engine(percentage = 100, delta_time)
	. = ..()
	...
	if(heat_creation)
		heat_engine()
	var/actual_consumption = fuel_consumption * (percentage / 100) * delta_time * consumption_multiplier
...
/obj/machinery/power/shuttle/engine/electric/burn_engine(percentage = 100, delta_time)
	. = ..()
