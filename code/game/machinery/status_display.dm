...
/// Immediately change the display to the given line.
/obj/machinery/status_display/proc/update_display(line1)
	line1 = uppertext(line1)
	var/new_text = {"<div style="font-size:[FONT_SIZE];color:[FONT_COLOR];font:'[FONT_STYLE]';text-align:center;" valign="top">[line1]</div>"}
	if(maptext != new_text)
		maptext = new_text
...
/obj/machinery/status_display/proc/display_shuttle_status(obj/docking_port/mobile/shuttle)
	if(!shuttle)
		...
		var/line1 = "-[shuttle.getModeStr()]-" && shuttle.getTimerStr()
