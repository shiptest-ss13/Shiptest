...
/obj/machinery
	...
	/// the id of the port (ship) this machinery is connected to
	var/port_id
...
/obj/machinery/connect_to_shuttle(mapload, obj/docking_port/mobile/port, obj/docking_port/stationary/dock)
	..()
	port_id = REF(port)
