...
/obj/machinery/door/firedoor/window
	...
	desc = "A second window that slides in when the original window is broken, designed to protect against hull breaches. Truly a work of genius by Makosso-Warra engineers."
	glass = TRUE
	explosion_block = 0
	max_integrity = 100
