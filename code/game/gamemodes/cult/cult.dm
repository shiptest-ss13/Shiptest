...
/datum/game_mode/cult
	...
	restricted_jobs = list("Chaplain","AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "First Officer", "Brig Physician", "Second Officer", "Prisoner")
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
