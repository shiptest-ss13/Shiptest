...
/datum/game_mode/changeling
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Brig Physician", "Protectorate Representative", "Prisoner") //WS edit - Brig Physicians, Protectorate Rep
	required_players = 15
	required_enemies = 1
