...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "First Officer", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Brig Physician", "Second Officer", "Prisoner")
	required_jobs = list(list("Captain"=1),list("First Officer"=1),list("Head of Security"=1),list("Chief Engineer"=1),list("Research Director"=1),list("Chief Medical Officer"=1)) //Any head present
	required_players = 20
	required_enemies = 1
