...
/atom/vv_do_topic(list/href_list)
	...
	if(href_list[VV_HK_EDIT_FILTERS] && check_right(R_ADMIN|R_DEBUG) && check_rights(R_VAREDIT)) //This needs to be like this due to the fact that I'm not coding a fucking UI state for R_VV for ONE BUTTON.
