...
/turf/open/floor/plating/planetary/drill_act(obj/item/mecha_parts/mecha_equipment/drill/drill)
	for(var/turf/open/floor/plating/planetary/M in range(1, drill.chassis))
