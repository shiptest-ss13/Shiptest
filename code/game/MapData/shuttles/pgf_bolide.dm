...
/obj/item/paper/fluff/ship/bolide/one
	...
	default_raw_text = {"<html>
			...
			<p>2. A Bolide-class Lander's mission profile is traditionally; landing in occupied regions, planetary assault in contested systems, construction of Navy Infrastructure, assistance of French Seventh Republic colonists, and aiding in conducting Federation Readiness Drills.</p>
