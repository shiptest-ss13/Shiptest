/obj/item/paper/fluff/ship/raleigh
	name = "The Contract"
	desc = "Wanna hire a mercenary? Get reading."
	default_raw_text = {"<html>
			...
			<body>
			<hr>
			<p align=right>Copy No. 5441</p>
			<center>
			<img height="100" src="https://cdn.discordapp.com/attachments/635216534922330117/1210356158506991617/pgf_roundel.png?ex=65ea4303&is=65d7ce03&hm=408c90df19939d1067fdf40f9439fb48f99f983c4742495c45e4662f329ac407&">
			<h3>Pan-Gezenan Federation</h3>
			<h2>Universal Battleship Linear Weapon Mounts</h2>
			<h4>Etherbor Lihmona Shipyards</h4>
			</center>
			<hr>
			<p>The Universal Colossal Battleship Linear Weapon Mount or simply "Universal Linear Mount" (USM), is a linear rail system that can be commonly found in many ships created in the Etherbor Lihmona Shipyards. Attachment of a weapon to a Universal Linear Mount requires the use of a Linear Mount Tool Facility. An engineering marvel are the massive machines at these facilities that effortlessly handle these systems on a regular basis. Most shipyards dealing in Kalixcian Colossal Arms will also have such a facility to install the weapons.</p>

			<p>The installation of weapons into a Universal Linear Mount is rather simplistic. A weapon must first be delivered to the Linear Mount Tool Facility, where it will be manually loaded onto the SMT's massive cargo lift. The SMT is then extended out around the weapon, and the weapon is then secured into the SMT with engaging locks. The next step is to bring the ship into the facility, placed just in line with the SMT. The weapon is then lined up with the Universal Linear Mount and slotted into place. The USM's hardware locks are then engaged, the weapon is welded to the USM, and electronic systems are hooked into the ship's computer systems. The weapons are then hooked into an independent power bank to prevent overdraw from main ship power banks, and prevent explosive backsurge.</p>

			<p>Common Colossal Battleship Weapons compatible with the Universal Linear Mount include the following:</p>

			<p><strong>HORUS Colossal Energy Cannon</strong></p>
			...
			<p><strong>SUPERNOVA High-Performance Giant Rail Cannon</strong></p>
			...
			<p><strong>Massive Ordinance Missile Array (B.O.M.B)</strong></p>
			...
			<p><strong>QUASAR SMITER Colossal Rail Cannon</strong></p>
