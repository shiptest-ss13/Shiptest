...
/turf/open/floor/plating/planetary/wasteplanet
	name = "dry rock"
...
/turf/open/floor/plating/planetary/wasteplanet/lit
	baseturfs = /turf/open/floor/plating/planetary/wasteplanet/lit
	lit = TRUE
	light_pwr = 0.2
