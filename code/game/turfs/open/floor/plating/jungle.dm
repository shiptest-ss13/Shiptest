...
/turf/open/floor/plating/dirt/MakeSlippery(wet_setting, min_wet_time, wet_time_to_add, max_wet_time, permanent)
	return

/turf/open/floor/plating/dirt/MakeDry()
	return

/turf/open/floor/plating/dirt/crush()
	return
