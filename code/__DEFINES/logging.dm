...
#define LOG_MSAY			(1 << 25) //Wasp Edit
#define LOG_LOOC			(1 << 26) //Wasp Edit
#define LOG_SUBTLER			(1 << 27) //Wasp Edit
...
#define INDIVIDUAL_OOC_LOG			(LOG_OOC | LOG_ADMIN | LOG_MSAY) //Wasp Edit - Mentors
