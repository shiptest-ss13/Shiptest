...
GLOBAL_LIST_INIT(podstyles, list(\
	...
	list(POD_SHAPE_NORML, "advpod",		TRUE,	"bluespace",	"blue",		RUBBLE_NORMAL,	"bluespace supply pod",	"A Makosso-Warra Bluespace supply pod. Teleports back to CentCom after delivery."),\
	list(POD_SHAPE_NORML, "advpod",		TRUE,	"centcom",		"blue",		RUBBLE_NORMAL,	"\improper CentCom supply pod", "A Makosso-Warra supply pod, this one has been marked with Central Command's designations. Teleports back to CentCom after delivery."),\
