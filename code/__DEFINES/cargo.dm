...
GLOBAL_LIST_INIT(podstyles, list(\
	...
	list(POD_SHAPE_NORML, "darkpod",	TRUE,	"deathsquad",	"blue",		RUBBLE_NORMAL,	"\improper Deathsquad drop pod",	"A Deathsquad drop pod. This one has been marked the markings of the Deathsquad, straight out of the comics!."),\
