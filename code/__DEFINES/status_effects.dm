...
#define STATUS_EFFECT_BLOODLUSTY /datum/status_effect/bloodlusty //Stun immunity and variable damage taken based on apply values
...
#define STATUS_EFFECT_DAMAGEANDKILLTRACKING /datum/status_effect/damage_kill_track //tracks total damage and calls reward proc on kill
