...
// shiptest max ship size defines

// neither of the shuttle's dimensions should exceed this size
#define SHUTTLE_MAX_SIZE_LONG 56
// only one of the shuttle's dimensions may exceed this size
#define SHUTTLE_MAX_SIZE_SHORT 40
// default # of tiles of padding around an autogenerated shuttle dock
#define SHUTTLE_DOCK_DEFAULT_PADDING 3
