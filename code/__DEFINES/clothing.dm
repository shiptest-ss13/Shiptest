...
#define EQUIP_DELAY_OVERSUIT (4 SECONDS)

/// Delay base for suit slot items
#define EQUIP_DELAY_SUIT (2 SECONDS)
...
#define EQUIP_DELAY_COAT (0.5 SECONDS)
/// Delay base for Undersuits.
#define EQUIP_DELAY_UNDERSUIT (2 SECONDS)

/// Delay base for masks.
#define EQUIP_DELAY_MASK (0.2 SECONDS)
/// Delay base for back-worn objects.
#define EQUIP_DELAY_BACK (0.5 SECONDS)
/// Delay base for belts.
#define EQUIP_DELAY_BELT (0.5 SECONDS)
/// Delay base for hats.
#define EQUIP_DELAY_HAT (0.2 SECONDS)
/// Delay base for gloves.
#define EQUIP_DELAY_GLOVES (0.2 SECONDS)
/// Delay base for glasses.
#define EQUIP_DELAY_EYEWEAR (0.2 SECONDS)
