...
#define WITHDRAWAL_STAGE1_END_CYCLE 360
#define WITHDRAWAL_STAGE2_START_CYCLE 361
#define WITHDRAWAL_STAGE2_END_CYCLE 720
#define WITHDRAWAL_STAGE3_START_CYCLE 721
