...
#define BOSS_MEDAL_PROPHET "False Prophet Disintegrator"
...
#define BOSS_MEDAL_PROPHET_CRUSHER "False Prophet Crusher"
...
#define PROPHET_SCORE "False Prophet Crusher"
