...
#define HUMAN_BODYTEMP_AUTORECOVERY_DIVISOR 28
...
#define HUMAN_BODYTEMP_HEATING_MAX 20
...
//LIZARD DEFINES
#define LIZARD_BODYTEMP_HEAT_DIVISOR 5
#define LIZARD_BODYTEMP_COLD_DIVISOR 5
#define LIZARD_BODYTEMP_AUTORECOVERY_DIVISOR 18
