...
#define NEW_ATTACHMENT_SLOT_MUZZLE (1<<0)
#define NEW_ATTACHMENT_SLOT_SCOPE (1<<1)
#define NEW_ATTACHMENT_SLOT_GRIP (1<<2)
#define NEW_ATTACHMENT_SLOT_RAIL (1<<3)

DEFINE_BITFIELD(attach_slots, list(
	ATTACHMENT_SLOT_MUZZLE = NEW_ATTACHMENT_SLOT_MUZZLE,
	ATTACHMENT_SLOT_SCOPE = NEW_ATTACHMENT_SLOT_SCOPE,
	ATTACHMENT_SLOT_GRIP = NEW_ATTACHMENT_SLOT_GRIP,
	ATTACHMENT_SLOT_RAIL = NEW_ATTACHMENT_SLOT_RAIL
))
