...
#define SMOOTH_GROUP_FLOOR_HEXACRETE S_TURF(10) ///turf/open/floor/concrete/hexacrete
...
#define SMOOTH_GROUP_SURVIVAL_TIANIUM_POD S_OBJ(15) ///turf/closed/wall/mineral/titanium/survival/pod, /obj/machinery/door/airlock/survival_pod, /obj/structure/window/shuttle/survival_pod
