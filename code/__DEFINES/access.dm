...
#define ACCESS_MECH_ENGINE 304
	...
	// For region access
#define REGION_ACCESS_ALL 0
#define REGION_ACCESS_SERVICE 1
#define REGION_ACCESS_SEC 2
#define REGION_ACCESS_MED 3
#define REGION_ACCESS_SCI 4
#define REGION_ACCESS_ENGI 5
#define REGION_ACCESS_SUPPLY 6
#define REGION_ACCESS_COMMAND 7
