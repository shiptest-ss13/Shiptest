...
#define COMSIG_KB_CLIENT_SAY_INDICATOR_DOWN "keybinding_client_say_indicator_down"
#define COMSIG_KB_CLIENT_ME_DOWN "keybinding_client_me_down"
#define COMSIG_KB_CLIENT_ME_INDICATOR_DOWN "keybinding_client_me_indicator_down"
