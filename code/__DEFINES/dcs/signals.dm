...
#define COMSIG_MOB_EQUIPPED_ITEM "mob_equipped_item" /// A mob has just equipped an item. Called on [/mob] from base of [/obj/item/equipped()]: (/obj/item/equipped_item, slot)
