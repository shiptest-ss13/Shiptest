...
/obj/item/reagent_containers/food/snacks/miras_parfait
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/eggyolk = 1, /datum/reagent/consumable/cream = 2, /datum/reagent/consumable/dotejuice = 4, /datum/reagent/consumable/sugar = 2)
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/cream = 2, /datum/reagent/consumable/dotejuice = 4, /datum/reagent/consumable/sugar = 1)
