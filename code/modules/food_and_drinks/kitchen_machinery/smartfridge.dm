...
/obj/machinery/smartfridge/bloodbank/accept_check(obj/item/O) //Literally copied bar smartfridge code
	if(!istype(O, /obj/item/reagent_containers) || (O.item_flags & ABSTRACT) || !O.reagents || !O.reagents.reagent_list.len)
		return FALSE
	if(istype(O, /obj/item/reagent_containers/glass/blood))
		return TRUE
	return FALSE
...
/obj/machinery/smartfridge/bloodbank/preloaded
	initial_contents = list(
		/obj/item/reagent_containers/glass/blood/AMinus = 1,
		/obj/item/reagent_containers/glass/blood/APlus = 1,
		/obj/item/reagent_containers/glass/blood/BMinus = 1,
		/obj/item/reagent_containers/glass/blood/BPlus = 1,
		...
		/obj/item/reagent_containers/glass/blood/squid = 1,
