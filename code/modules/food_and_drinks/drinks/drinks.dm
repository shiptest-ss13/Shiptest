...
/obj/item/reagent_containers/food/drinks/soda_cans/vimukti
	name = "Vimukti"
	desc = "A liquor brewed from sweet lichen scraped off the walls of Shoal water condensers. Stamped with the thirteen-spoked wheel of enlightenment. Spiritual Vox consider it to open the mind's boundaries. Doctors advise not to drink it before operating heavy machinery."
