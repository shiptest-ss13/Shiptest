...
/datum/planet_type/dustball
	name = "dustball dwarf planet"
	desc = "A world entirely covered in dust; there is with absolute certainty nothing of interest here."
