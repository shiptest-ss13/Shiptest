...
// DEBUG: becoming pretty much untenable due to too much behavior in /datum/overmap/dynamic. there is no goddamn way this shit works
/datum/overmap/dynamic/outpost
	...
	// DEBUG: ughghghrghg this shadows outer scope
