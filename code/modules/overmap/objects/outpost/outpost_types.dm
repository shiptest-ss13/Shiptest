...
/*
	Gorlex Jungle Outpost
*/

/datum/map_template/outpost/gorlex_jungle
	name = "gorlex_jungle"
...
/datum/overmap/outpost/gorlex_jungle
	token_icon_state = "station_asteroid_0"
	main_template = /datum/map_template/outpost/gorlex_jungle
	elevator_template = /datum/map_template/outpost/elevator_test
