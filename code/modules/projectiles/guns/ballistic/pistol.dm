...
/obj/item/gun/ballistic/automatic/pistol/solgov
	...
	desc = "Known formally as the M9A5C, this is a service pistol chambered in 5.56mm HITP caseless. The high-velocity ammo performs better against armor than most pistols."
	icon_state = "solm9c"
	weapon_weight = WEAPON_LIGHT
	w_class = WEIGHT_CLASS_SMALL
