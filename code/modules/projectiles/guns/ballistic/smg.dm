...
/obj/item/gun/ballistic/automatic/smg/cm5
	name = "\improper CM-5"
	desc = "The standard issue SMG of the CMM. One of the few firearm designs that were left mostly intact from designs found on a salvaged ship. Chambered in 9mm."
	icon_state = "cm5"
	item_state = "cm5"
	mag_type = /obj/item/ammo_box/magazine/smgm9mm
	weapon_weight = WEAPON_LIGHT
