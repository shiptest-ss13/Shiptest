...
/obj/item/gun/ballistic/automatic/marksman/boomslang
	...
	desc = "A bullpup semi-automatic sniper rifle with a high-magnification scope. Compact and capable of rapid follow-up fire without sacrificing power. Used by Syndicate support units and infiltrators during the ICW. Chambered in 6.5x55mm CLIP."
...
/obj/item/gun/ballistic/automatic/marksman/boomslang/indie
	name = "Boomslang-90"
	desc = "A modern semi-automatic hunting rifle. Its relative portability and fast follow-up potential compared to other weapons in its class have made it very popular with well-to-do hunters and the occasional law enforcement agency or mercenary. Chambered in 6.5x55mm CLIP."
...
/obj/item/ammo_box/magazine/boomslang
	name = "\improper Boomslang Magazine (6.5x55mm CLIP)"
