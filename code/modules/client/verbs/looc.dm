...
/client/verb/looc(msg as text)
	...
	for(var/mob/hearer_mob in heard)
		...
		if(GLOB.LOOC_COLOR)
			to_chat(hearer, span_loocplain("<font color='[GLOB.LOOC_COLOR]'><b><span class='prefix'>LOOC:</span> <EM>[mob.get_screentip_name(hearer)]:</EM> <span class='message'>[msg]</span></b></font>") , MESSAGE_TYPE_LOOC)
		else
			to_chat(hearer, span_looc("<span class='prefix'>LOOC:</span> <EM>[mob.get_screentip_name(hearer)]:</EM> <span class='message'>[msg]</span>") , MESSAGE_TYPE_LOOC)
	...
	for(var/client/C in GLOB.admins)
		...
		if (C.mob in heard)
			prefix = "LOOC"
		if(GLOB.LOOC_COLOR)
			to_chat(C, span_loocplain("<font color='[GLOB.LOOC_COLOR]'><b>[ADMIN_FLW(usr)] <span class='prefix'>[prefix]:</span> <EM>[key]/[mob.real_name]:</EM> <span class='message'>[msg]</span></b></font>") , MESSAGE_TYPE_LOOC)
		else
			to_chat(C, span_looc("[ADMIN_FLW(usr)] <span class='prefix'>[prefix]:</span> <EM>[key]/[mob.real_name]:</EM> <span class='message'>[msg]</span>") , MESSAGE_TYPE_LOOC)
