...
/datum/body_marking/other
	icon = 'modular_zubbers/modules/customization/icons/body_markings/other_markings.dmi'
...
/datum/body_marking/secondary
	icon = 'modular_zubbers/modules/customization/icons/body_markings/secondary_markings.dmi'
...
/datum/body_marking/tertiary
	icon = 'modular_zubbers/modules/customization/icons/body_markings/tertiary_markings.dmi'
...
/datum/body_marking/tattoo
	icon = 'modular_zubbers/modules/customization/icons/body_markings/tattoo_markings.dmi'
	recommended_species = null
