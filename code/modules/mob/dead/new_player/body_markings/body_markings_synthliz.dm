/datum/body_marking/secondary/synthliz
	icon = 'modular_zubbers/modules/customization/icons/body_markings/synthliz_secondary.dmi'
...
/datum/body_marking/tertiary/synthliz
	icon = 'modular_zubbers/modules/customization/icons/body_markings/synthliz_tertiary.dmi'
	recommended_species = list("synthliz")
