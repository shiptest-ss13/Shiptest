/datum/body_marking/moth
	icon = 'modular_zubbers/modules/customization/icons/body_markings/moth_markings.dmi'
	default_color = "FFF"
...
/datum/body_marking/moth/grayscale
	icon = 'modular_zubbers/modules/customization/icons/body_markings/moth_grayscale_markings.dmi'
