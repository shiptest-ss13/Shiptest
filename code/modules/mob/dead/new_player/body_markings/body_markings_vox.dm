/datum/body_marking/secondary/vox
	icon = 'modular_zubbers/modules/customization/icons/body_markings/vox_secondary.dmi'
...
/datum/body_marking/tertiary/vox
	recommended_species = list("vox")
	icon = 'modular_zubbers/modules/customization/icons/body_markings/vox_tertiary.dmi'
