...
//Moth head types
/datum/sprite_accessory/moth_head
	icon = 'icons/mob/species/moth/moth_head.dmi'
	color_src = BODYFLUFFCOLORS
...
/datum/sprite_accessory/moth_head/probiscis
	name = "Probiscis"
	icon_state = "probiscis"

/datum/sprite_accessory/moth_head/mandible
	name = "Mandible"
	icon_state = "mandible"
