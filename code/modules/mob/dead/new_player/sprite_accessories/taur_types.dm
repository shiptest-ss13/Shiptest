/datum/sprite_accessory/taur
	icon = 'modular_zubbers/modules/customization/icons/sprite_accessory/taur.dmi'
	key = "taur"
	generic = "Taur Type"
...
/datum/sprite_accessory/taur/is_hidden(mob/living/carbon/human/H, obj/item/bodypart/HD)
	if(H.wear_suit && (H.wear_suit.flags_inv & HIDEJUMPSUIT))
		return TRUE
//	if(H.owned_turf) // TODO: prooobably port the thing that lets you plop down your tails
