...
/datum/sprite_accessory/ears/mutant
	icon = 'modular_zubbers/modules/customization/icons/sprite_accessory/ears.dmi'
	organ_type = /obj/item/organ/ears/mutant
...
/datum/sprite_accessory/ears/mutant/akula
	recommended_species = list(SPECIES_SYNTHMAMMAL, SPECIES_MAMMAL, SPECIES_HUMAN, SPECIES_SYNTHHUMAN, SPECIES_AQUATIC, SPECIES_AKULA, SPECIES_HUMANOID, SPECIES_GHOUL)
