...
/datum/sprite_accessory
	...
	var/primary_color_overlay			//Decides if this sprite has a overlay using primar in use.
	var/secondary_color_overlay					//Decides if this sprite has a secondary color in use.
