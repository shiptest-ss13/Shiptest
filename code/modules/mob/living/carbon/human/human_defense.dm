...
/mob/living/carbon/human/attack_animal(mob/living/simple_animal/M)
	...
	if(.)
		...
		if(check_shields(M, damage, "the [M.name]", MELEE_ATTACK, M.armour_penetration))
			return FALSE
		var/dam_zone = dismembering_strike(M, pick_weight(list(BODY_ZONE_HEAD = 2, BODY_ZONE_CHEST = 78, BODY_ZONE_L_ARM = 5, BODY_ZONE_R_ARM = 5, BODY_ZONE_L_LEG = 5, BODY_ZONE_R_LEG = 5)))
