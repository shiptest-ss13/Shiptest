...
/mob/living/carbon/proc/check_breath(datum/gas_mixture/breath)
	...
	var/Toxins_partialpressure = ((breath.get_moles(GAS_PLASMA)+breath.get_moles(GAS_CONSTRICTED_PLASMA))/moles)*breath_pressure
	...
	if(Toxins_partialpressure > safe_tox_max)
		var/ratio = ((breath.get_moles(GAS_PLASMA)+breath.get_moles(GAS_CONSTRICTED_PLASMA))/safe_tox_max) * 10
