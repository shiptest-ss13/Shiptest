...
/mob/living/carbon/proc/init_bioscrambler_lists()
	var/list/body_parts = typesof(/obj/item/bodypart/chest) + typesof(/obj/item/bodypart/head) + subtypesof(/obj/item/bodypart/l_arm) + subtypesof(/obj/item/bodypart/r_arm) + subtypesof(/obj/item/bodypart/leg/left) + subtypesof(/obj/item/bodypart/leg/right)
