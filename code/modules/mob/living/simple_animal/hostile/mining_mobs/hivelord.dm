...
/obj/effect/mob_spawn/human/corpse/damaged/legioninfested/Initialize()
	...
	switch(type)
		if("Miner")
			...
			if(prob(30))
				r_pocket = pickweight(list(/obj/item/stack/marker_beacon/default = 20, /obj/item/spacecash/bundle/mediumrand = 7, /obj/item/reagent_containers/hypospray/medipen/survival = 2, /obj/item/borg/upgrade/modkit/damage = 1))
			if(prob(10))
			...
			if(prob(95))
				...
				if(prob(70))
					backpack_contents += pick(list(/obj/item/borg/upgrade/modkit/damage = 1, /obj/item/borg/upgrade/modkit/trigger_guard = 1, /obj/item/soap/nanotrasen = 1, /obj/item/wormhole_jaunter = 1, /obj/item/fulton_core = 1, /obj/item/extraction_pack = 2, /obj/item/stack/sheet/animalhide/goliath_hide = 3, /obj/item/hivelordstabilizer = 2, /obj/item/stack/marker_beacon/default/ten = 2, /obj/item/mining_scanner = 2, /obj/item/extinguisher/mini = 2, /obj/item/kitchen/knife/combat/survival = 3, /obj/item/flashlight/seclite=3, /obj/item/stack/sheet/sinew = 3, /obj/item/stack/sheet/bone = 3))
				if(prob(70))
					backpack_contents += pick(list(/obj/item/borg/upgrade/modkit/damage = 1, /obj/item/borg/upgrade/modkit/trigger_guard = 1, /obj/item/soap/nanotrasen = 1, /obj/item/wormhole_jaunter = 1, /obj/item/fulton_core = 1, /obj/item/extraction_pack = 2, /obj/item/stack/sheet/animalhide/goliath_hide = 3, /obj/item/hivelordstabilizer = 2, /obj/item/stack/marker_beacon/default/ten = 2, /obj/item/mining_scanner = 2, /obj/item/extinguisher/mini = 2, /obj/item/kitchen/knife/combat/survival = 3, /obj/item/flashlight/seclite=3, /obj/item/stack/sheet/sinew = 3, /obj/item/stack/sheet/bone = 3))
				if(prob(70))
					backpack_contents += pick(list(/obj/item/borg/upgrade/modkit/damage = 1, /obj/item/borg/upgrade/modkit/trigger_guard = 1, /obj/item/soap/nanotrasen = 1, /obj/item/wormhole_jaunter = 1, /obj/item/fulton_core = 1, /obj/item/extraction_pack = 2, /obj/item/stack/sheet/animalhide/goliath_hide = 3, /obj/item/hivelordstabilizer = 2, /obj/item/stack/marker_beacon/default/ten = 2, /obj/item/mining_scanner = 2, /obj/item/extinguisher/mini = 2, /obj/item/kitchen/knife/combat/survival = 3, /obj/item/flashlight/seclite=3, /obj/item/stack/sheet/sinew = 3, /obj/item/stack/sheet/bone = 3))
		...
		if("Soldier")
			...
			if(prob(85))
				...
				backpack_contents = list()
				if(prob(75))
					backpack_contents += pick(list(/obj/item/reagent_containers/hypospray/medipen/stimpack/traitor = 1, /obj/item/storage/firstaid/tactical = 1, /obj/item/gun/ballistic/automatic/pistol/solgov = 1, /obj/item/gps = 1, /obj/item/stock_parts/cell/gun/upgraded = 2, /obj/item/ammo_box/magazine/pistol556mm = 3, /obj/item/desk_flag/solgov = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/detective_scanner = 2, /obj/item/extinguisher/mini = 3, /obj/item/kitchen/knife/combat = 3, /obj/item/flashlight/seclite=3, /obj/item/ammo_casing/shotgun = 3, /obj/item/binoculars = 3, /obj/item/clipboard = 3))
				if(prob(75))
					backpack_contents += pick(list(/obj/item/reagent_containers/hypospray/medipen/stimpack/traitor = 1, /obj/item/storage/firstaid/tactical = 1, /obj/item/gun/ballistic/automatic/pistol/solgov = 1, /obj/item/gps = 1, /obj/item/stock_parts/cell/gun/upgraded = 2, /obj/item/ammo_box/magazine/pistol556mm = 3, /obj/item/desk_flag/solgov = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/detective_scanner = 2, /obj/item/extinguisher/mini = 3, /obj/item/kitchen/knife/combat = 3, /obj/item/flashlight/seclite=3, /obj/item/ammo_casing/shotgun = 3, /obj/item/binoculars = 3, /obj/item/clipboard = 3))
				if(prob(75))
					backpack_contents += pick(list(/obj/item/reagent_containers/hypospray/medipen/stimpack/traitor = 1, /obj/item/storage/firstaid/tactical = 1, /obj/item/gun/ballistic/automatic/pistol/solgov = 1, /obj/item/gps = 1, /obj/item/stock_parts/cell/gun/upgraded = 2, /obj/item/ammo_box/magazine/pistol556mm = 3, /obj/item/desk_flag/solgov = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/detective_scanner = 2, /obj/item/extinguisher/mini = 3, /obj/item/kitchen/knife/combat = 3, /obj/item/flashlight/seclite=3, /obj/item/ammo_casing/shotgun = 3, /obj/item/binoculars = 3, /obj/item/clipboard = 3))
		...
		if("Golem")
			...
			if(prob(70))
				...
				backpack_contents = list()
				if(prob(75))
					backpack_contents += pick(list(/obj/item/slime_extract/grey = 1, /obj/item/slime_scanner = 1, /obj/item/resonator/upgraded = 1, /obj/item/gps = 1, /obj/item/fulton_core = 2, /obj/item/extraction_pack = 3, /obj/item/stack/sheet/mineral/plasma/twenty = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/mining_scanner = 2, /obj/item/extinguisher/mini = 3, /obj/item/flashlight/seclite=3, /obj/item/research_notes/loot/medium = 3, /obj/item/stack/sheet/metal/fifty = 3, /obj/item/research_notes/loot/big = 1))
				if(prob(75))
					backpack_contents += pick(list(/obj/item/slime_extract/grey = 1, /obj/item/slime_scanner = 1, /obj/item/resonator/upgraded = 1, /obj/item/gps = 1, /obj/item/fulton_core = 2, /obj/item/extraction_pack = 3, /obj/item/stack/sheet/mineral/plasma/twenty = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/mining_scanner = 2, /obj/item/extinguisher/mini = 3, /obj/item/flashlight/seclite=3, /obj/item/research_notes/loot/medium = 3, /obj/item/stack/sheet/metal/fifty = 3, /obj/item/research_notes/loot/big = 1))
				if(prob(75))
					backpack_contents += pick(list(/obj/item/slime_extract/grey = 1, /obj/item/slime_scanner = 1, /obj/item/resonator/upgraded = 1, /obj/item/gps = 1, /obj/item/fulton_core = 2, /obj/item/extraction_pack = 3, /obj/item/stack/sheet/mineral/plasma/twenty = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/mining_scanner = 2, /obj/item/extinguisher/mini = 3, /obj/item/flashlight/seclite=3, /obj/item/research_notes/loot/medium = 3, /obj/item/stack/sheet/metal/fifty = 3, /obj/item/research_notes/loot/big = 1))
		...
		if("Waldo")//WE FINALLY FOUND HIM
			...
			backpack_contents = list()
			if(prob(50))
				backpack_contents += pick(list(/obj/item/book/granter/spell/knock = 1, /obj/item/book/granter/spell/blind = 1, /obj/item/shadowcloak = 1, /obj/item/book/granter/spell/smoke = 2, /obj/item/reagent_containers/syringe/mulligan = 2, /obj/item/dice/d20/fate/stealth/one_use = 1, /obj/item/clothing/head/chameleon/broken = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/grenade/smokebomb = 3, /obj/item/grenade/flashbang = 3))
			if(prob(50))
				backpack_contents += pick(list(/obj/item/book/granter/spell/knock = 1, /obj/item/book/granter/spell/blind = 1, /obj/item/shadowcloak = 1, /obj/item/book/granter/spell/smoke = 2, /obj/item/reagent_containers/syringe/mulligan = 2, /obj/item/dice/d20/fate/stealth/one_use = 1, /obj/item/clothing/head/chameleon/broken = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/grenade/smokebomb = 3, /obj/item/grenade/flashbang = 3))
			if(prob(50))
				backpack_contents += pick(list(/obj/item/book/granter/spell/knock = 1, /obj/item/book/granter/spell/blind = 1, /obj/item/shadowcloak = 1, /obj/item/book/granter/spell/smoke = 2, /obj/item/reagent_containers/syringe/mulligan = 2, /obj/item/dice/d20/fate/stealth/one_use = 1, /obj/item/clothing/head/chameleon/broken = 3, /obj/item/stack/marker_beacon/default/ten = 3, /obj/item/grenade/smokebomb = 3, /obj/item/grenade/flashbang = 3))
