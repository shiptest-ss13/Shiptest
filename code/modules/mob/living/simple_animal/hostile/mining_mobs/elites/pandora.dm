...
/mob/living/simple_animal/hostile/asteroid/elite/pandora/proc/singular_shot_line(procsleft, var/angleused, var/turf/T)
	if(procsleft <= 0)
		return
...
/mob/living/simple_animal/hostile/asteroid/elite/pandora/proc/pandora_teleport_2(turf/T, var/turf/source)
...
/mob/living/simple_animal/hostile/asteroid/elite/pandora/proc/aoe_squares_2(turf/T, var/ring, var/max_size)
	if(ring > max_size)
		return
