...
/mob/living/simple_animal/hostile/megafauna/blood_drunk_miner
	...
	pixel_x = -16
	base_pixel_x = -16
	crusher_loot = list(/obj/item/melee/transforming/cleaving_saw, /obj/item/gun/energy/kinetic_accelerator, /obj/item/crusher_trophy/miner_eye, /obj/item/sharpener/bleed)
	loot = list(/obj/item/melee/transforming/cleaving_saw, /obj/item/gun/energy/kinetic_accelerator, /obj/item/sharpener/bleed)
	wander = FALSE
	del_on_death = TRUE
