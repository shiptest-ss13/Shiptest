/mob/living/simple_animal/hostile/feral_doctor
	name = "Feral Doctor"
	desc = "A doctor with a crazed look in their eye, they don't seem happy to see you."
	...
	loot = list(/obj/effect/mob_spawn/human/corpse/feral_doctor, /obj/item/circular_saw, /obj/item/gun/syringe)
...
/mob/living/simple_animal/hostile/feral_doctor/CanAttack(atom/the_target)
	if(iscarbon(target))
...
/mob/living/simple_animal/hostile/feral_doctor/AttackingTarget()
	if(iscarbon(target))
