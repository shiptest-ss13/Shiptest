...
/mob/living/silicon/proc/deadchat_lawchange()
	...
	deadchat_broadcast("'s <b>laws were changed.</b> <a href='?src=[REF(src)]&printlawtext=[url_encode(lawtext)]'>View</a>", span_name("[src]"), follow_target=src, message_type=DEADCHAT_LAWCHANGE)
