...
/obj/item/organ/stomach/ethereal
	...
	var/crystal_charge = ELZUOSA_CHARGE_FULL

/obj/item/organ/stomach/ethereal/on_life()
	..()
	adjust_charge(-ELZUOSA_CHARGE_FACTOR)
...
/obj/item/organ/stomach/ethereal/proc/get_status_tab_item(mob/living/carbon/source, list/items)
	SIGNAL_HANDLER
	items += "Crystal Charge: [round((crystal_charge / ELZUOSA_CHARGE_SCALING_MULTIPLIER), 0.1)]%"

/obj/item/organ/stomach/ethereal/proc/charge(datum/source, amount, repairs)
	adjust_charge((amount * ELZUOSA_CHARGE_SCALING_MULTIPLIER) / 70)      //WS Edit -- Ethereal Charge Scaling
...
/obj/item/organ/stomach/ethereal/proc/adjust_charge(amount)
	crystal_charge = clamp(crystal_charge + amount, ELZUOSA_CHARGE_NONE, ELZUOSA_CHARGE_DANGEROUS)
