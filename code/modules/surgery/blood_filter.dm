...
/datum/surgery_step/filter_blood/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(user, target, span_notice("You begin to filter [target]'s veins..."),
		span_notice("[user] begins to filter [target]'s veins."),
		span_notice("[user] begins to filter through [target]'s veins."))
