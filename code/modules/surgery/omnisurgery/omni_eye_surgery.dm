...
/datum/surgery_step/omni/fix_eyes
	...
	valid_locations = list(BODY_ZONE_PRECISE_EYES)
	required_layer = list(1)
	show = TRUE

/datum/surgery/omni/eye_surgery/can_start(mob/user, mob/living/carbon/target)
...
/datum/surgery_step/omni/fix_eyes/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
...
/datum/surgery_step/omni/fix_eyes/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	var/obj/item/organ/eyes/E = target.getorganslot(ORGAN_SLOT_EYES)
...
/datum/surgery_step/omni/fix_eyes/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
