...
/datum/mission/basic/drill/generate_mission_details()
	. = ..()
	num_wanted = rand(num_wanted-2,num_wanted+2)
	value += num_wanted*100

/datum/mission/basic/drill/accept(datum/overmap/ship/controlled/acceptor, turf/accept_loc)
	. = ..()
...
/datum/mission/basic/drill/turn_in()
	value += (sampler.num_current - num_wanted)*50
	. = ..()

/datum/mission/basic/drill/can_complete()
	. = ..()
	if(!.)
		return
...
/datum/mission/basic/drill/get_progress_string()
	if(!sampler)
		return "0/[num_wanted]"
	else
		return "[sampler.num_current]/[num_wanted]"

/datum/mission/basic/drill/Destroy()
	sampler = null
	return ..()
...
/datum/mission/basic/drill/give_up()
	recall_bound(sampler)
	return ..()

/datum/mission/basic/drill/classtwo
...
/datum/mission/basic/drill/classthree
