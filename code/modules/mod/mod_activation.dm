...
/obj/item/mod/control/proc/choose_deploy(mob/user)
	...
	if(part.loc == src)
		deploy(user, part)
		//SEND_SIGNAL(src, COMSIG_MOD_DEPLOYED, user) todo: mod deploy signal
...
/obj/item/mod/control/proc/quick_deploy(mob/user)
	...
	wearer.visible_message(
		span_notice("[wearer]'s [src] [deploy ? "deploys" : "retracts"] its parts with a mechanical hiss."),
...
/obj/item/mod/control/proc/retract(mob/user, obj/item/part)
	...
	wearer.visible_message(
		span_notice("[wearer]'s [part.name] retract[part.p_s()] back into [src] with a mechanical hiss."),
...
/obj/item/mod/control/proc/seal_part(obj/item/clothing/part, is_sealed)
	...
	// wearer.update_clothing(part.slot_flags) todo fix
