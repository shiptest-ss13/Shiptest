...
/obj/item/paper/codelab/reception
	...
	info = "RECITE TO ANY GUESTS UNDER 'EXPERIMENTAL' GROUP:<BR> Welcome to the Nanotrasen Genetic Research Facility! Thank you for choosing to volunteer and progress genetic research by leaps and bounds. As stated in the contract, you will be here for the forseeable future helping the scientists further their studies. Remember that signing the contract means you cannot legally request a settlement for any injury or death that occurs during testing. Head to your chamber through the hall on the left and have a nice day!"

/obj/item/paper/crumpled/codelab/subjectnote
	name = "Test Subjects Note"
	info = "<i>This testing had better be worth it. I've always wanted to have cat ears.<BR> Not sure what all that gooey stuff I saw was, but at least I'll be in the cryo cell away from it.<BR><BR> And whats up with the floor tiles in the hall?"
