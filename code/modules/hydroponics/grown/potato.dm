...
/obj/item/seeds/potato
	...
	mutatelist = list(/obj/item/seeds/potatosweet)
...
/obj/item/reagent_containers/food/snacks/grown/potatosweet
	seed = /obj/item/seeds/potatosweet
	name = "sweet potato"
	desc = "It's sweet."
