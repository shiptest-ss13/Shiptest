...
/obj/item/food/grown/citrus/lime/make_processable()
...
/obj/item/food/grown/citrus/lemon/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/garnish/lemon, 3, 3 SECONDS, table_required = TRUE)
