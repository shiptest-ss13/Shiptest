...
/proc/curse_of_madness(mob/user, message)
	...
	deadchat_broadcast("A [span_name("Curse of Madness")] has stricken the sector, shattering their minds with the awful secret: \"<span class='big hypnophrase'>[message]</span>\"", message_type=DEADCHAT_ANNOUNCEMENT)
