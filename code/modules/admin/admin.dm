...
/datum/admins/proc/announce()
	...
	SSshipbot.relay_ooc("[usr.client.holder.fakekey ? "Administrator" : usr.key]", "**Announcement:\n[message]**")
...
/datum/admins/proc/toggleooc()
	...
	SSshipbot.relay_ooc("SERVER", "**OOC HAS BEEN [GLOB.ooc_allowed ? "ENABLED" : "DISABLED"].")
	SSshipbot.relay_flag("ooc-enabled", GLOB.ooc_allowed)
