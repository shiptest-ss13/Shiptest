...
/datum/admin_help/proc/SkillIssue(key_name = key_name_admin(usr))
	...
	msg += "<font color='red'>Your issue has been determined by an administrator to be a skill issue and does NOT require administrator intervention at this time. For further resolution you should pursue options that involve being better at the game.</font><br>"
	...
	message_admins(msg)
	log_admin_private(msg)
	AddInteraction("red", "Marked as skill issue by [key_name]")
