/client/proc/panicbunker()
	...
	SSshipbot.relay_channel("admin-server", "[key_name(usr)] has toggled the Panic Bunker, it is now [new_pb ? "enabled with a living minutes requirement of [time_rec]. The interview system is [interview ? "enabled" : "disabled"]" : "disabled"].")
