...
/client/proc/map_template_upload()
	...
	if(template_type == "Shuttle")
		...
		shuttle_template.faction = new /datum/faction/independent //as factions were moved to map templates from datum/overmap/ship, uploading shuttle templates was broken for a while
