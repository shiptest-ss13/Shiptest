...
/obj/item/dragons_blood/attack_self(mob/living/carbon/human/user)
	...
	switch(random)
		if(1)
			...
			H.dna.features = list("mcolor" = "A02720", "tail_human" = "None", "face_markings" = "None", "horns" = "Curled", "ears" = "None", "wings" = "None", "frills" = "None", "spines" = "Long", "body_markings" = "Dark Tiger Body")
			H.eye_color = "fee5a3"
