...
/obj/structure/closet/crate/necropolis/tendril
	desc = "It's watching you wearily."
...
/obj/structure/closet/crate/necropolis/tendril/PopulateContents()
	...
	switch(loot)
		...
		if(13)
			...
			new /obj/item/storage/toolbox/ammo/a762(src)
		if(14)
			new /obj/item/strange_crystal(src)
			new /obj/item/strange_crystal(src)
			new /obj/item/strange_crystal(src)
			new /obj/item/strange_crystal(src)
			new /obj/item/strange_crystal(src)
		if(15)
			new /obj/item/clothing/neck/crystal_amulet(src)
		if(16)
			new /mob/living/simple_animal/hostile/facehugger(src) //jumpscare
