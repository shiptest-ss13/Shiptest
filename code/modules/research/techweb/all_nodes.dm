...
/datum/techweb_node/adv_surgery
	...
	design_ids = list("surgery_advanced_neurosurgery", "surgery_heal_brute_upgrade_femto", "surgery_heal_burn_upgrade_femto","surgery_heal_combo","surgery_adv_dissection")
