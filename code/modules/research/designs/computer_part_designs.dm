...
/datum/design/disk/cluster
	...
	id = "hdd_cluster"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 3200, /datum/material/glass = 1000)
...
/datum/design/disk/small
	...
	id = "ssd_small"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 800, /datum/material/glass = 1000)
...
/datum/design/disk/micro
	...
	id = "ssd_micro"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 400, /datum/material/glass = 1000)
