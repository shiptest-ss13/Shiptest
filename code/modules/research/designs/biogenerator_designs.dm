...
/datum/design/gatfruit
	name = "Gatfruit Seeds"
	id = "gatfruit_seeds"
	build_type = BIOGENERATOR
	materials = list(/datum/material/biomass= 100000)
	build_path = /obj/item/seeds/gatfruit
	category = list("initial","Contraband")

/datum/design/cherrybomb
	name = "Cherrybomb Seeds"
	id = "cherrybomb_seeds"
	build_type = BIOGENERATOR
	materials = list(/datum/material/biomass= 100000)
	build_path = /obj/item/seeds/cherry/bomb
	category = list("initial","Contraband")