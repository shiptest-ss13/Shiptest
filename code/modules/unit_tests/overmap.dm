/datum/unit_test/overmap_move/Run()
	...
	S.process(1)
	TEST_ASSERT_EQUAL(MAGNITUDE(S.speed_x, S.speed_y), S.acceleration_speed * (S.burn_percentage / 100), "Ship did not increase to proper speed after burning engines")
	...
	S.process(1)
	TEST_ASSERT_EQUAL(MAGNITUDE(S.speed_x, S.speed_y), S.acceleration_speed / SQRT_2, "Ship did not stay at proper speed after stopping engines")
