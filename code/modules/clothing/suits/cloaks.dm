...
/obj/item/clothing/suit/hooded/cloak/goliath
	...
	armor = list("melee" = 35, "bullet" = 10, "laser" = 25, "energy" = 35, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60, "wounds" = 10) //a fair alternative to bone armor, requiring alternative materials and gaining a suit slot
...
/obj/item/clothing/head/hooded/cloakhood/goliath
	...
	armor = list("melee" = 35, "bullet" = 10, "laser" = 25, "energy" = 35, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60, "wounds" = 10)
