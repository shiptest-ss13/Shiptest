/obj/machinery/fax
	...
	var/list/special_networks = list(
		...
		list(fax_name = "USCM Communications Quartermaster", fax_id = "frontiersmen", color = "black", emag_needed = TRUE)
	)
...
/obj/machinery/fax/admin/solgov
	name = "Protectorate Frontier Affairs Fax Machine"
...
/obj/machinery/fax/admin/frontiersmen
	...
	fax_name = "USCM Communications Quartermaster"
