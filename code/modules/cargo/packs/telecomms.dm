...
/datum/supply_pack/tcomms/broadcaster
	...
	desc = "A subspace broadcaster. Broadcasts received and processed radio signals as dense packets of information through subspace."
	cost = 1500
	contains = list(
		/obj/item/circuitboard/machine/telecomms/broadcaster,
		/obj/item/stock_parts/subspace/filter,
...
/datum/supply_pack/tcomms/bus
	...
	desc = "A bus mainframe. Moves signals to the requisite telecommunications machine once linked."
	cost = 1500
	contains = list(
		/obj/item/circuitboard/machine/telecomms/bus,
		/obj/item/stock_parts/subspace/filter,
...
/datum/supply_pack/tcomms/processor
	...
	desc = "A signal processor. Decompresses and decodes subspace radio signals."
	cost = 1500
	contains = list(
		/obj/item/circuitboard/machine/telecomms/processor,
		/obj/item/stock_parts/subspace/filter,
...
/datum/supply_pack/tcomms/receiver
	name = "Receiver Crate"
	desc = "A subspace receiver. Catches radio signals being broadcast through subspace."
	cost = 1500
	contains = list(
		/obj/item/circuitboard/machine/telecomms/receiver,
		/obj/item/stock_parts/subspace/filter,
...
/datum/supply_pack/tcomms/server
	...
	desc = "A telecommunications server. Logs radio signals passed through it for future reference."
	cost = 1500
	contains = list(
...
/datum/supply_pack/tcomms/pda_server
	...
	desc = "A PDA Server. Translates radio bursts from PDA messaging into a subspace-friendly packet."
	cost = 1500
	contains = list(
...
/datum/supply_pack/tcomms/relay
	...
	desc = "A subspace relay. Creates paths through exotic subspace geometry to broadcast signals to other known relays. "
	cost = 1500
	contains = list(
...
/datum/supply_pack/tcomms/hub
	...
	desc = "A telecommunications hub. The centerpiece of any functional telecommunications set up. Routes all data fed to it. "
	cost = 1500
	contains = list(
