...
/datum/supply_pack/gun/riot_shotgun
	...
	desc = "For when the greytide gets out of hand. Contains 2 pump shotguns and shotgun ammo bandoliers to go with."
	cost = 8000
...
/datum/supply_pack/gun/ballistic
	...
	desc = "For when the enemy absolutely needs to be replaced with lead. Contains two Aussec-designed combat shotguns, and two bandoliers."
	cost = 10000
...
/datum/supply_pack/gun/winchester
	...
	desc = "Contains two lever action rifles intended for hunting wildlife. Chambered in .38 rounds."
	cost = 9000
