...
/datum/supply_pack/gun/boomslang90
	...
	desc = "Contains a civilian variant of the Boomslang Sniper rifle- modified with a 2x scope, rather than a sniper scope. Chambered in the powerful 6.5x55mm CLIP."
	cost = 3500
...
/datum/supply_pack/gun/boomslang10
	...
	desc = "Contains a military variant of the Boomslang Sniper rifle equipped with an 8x sniper scope, for licenesed buyers only. Chambered in the powerful 6.5x55mm CLIP."
	cost = 4500
...
/datum/supply_pack/gun/f90
	...
	desc = "Contains a military sniper rifle equipped with an 8x sniper scope, for Minuteman use only. Chambered in the powerful 6.5x55mm CLIP."
	cost = 4500
