...
/datum/blackmarket_item/tech/remote_control
	name = "Remote Uplink Positronic Frame Controller"
	desc = "We went in after some Cliquists raided some research station, found some kinda radio thing in the robotics lab. Looks about the size of a posibrain."
	item = /obj/item/organ/brain/remote_control
