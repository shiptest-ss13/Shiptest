...
/datum/blackmarket_item/clothing/gezena_armor
	...
	desc = "A genuine set of Arbitrator body armor used by the PGF Marine Corp. We even tossed in one of their little mask thingies. If a military guy in a cape comes by, play dumb."
	item =  /obj/item/storage/backpack/duffelbag/sec
