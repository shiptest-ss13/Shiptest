...
/datum/reagent/consumable/doctor_delight/on_mob_life(mob/living/carbon/metabolizer, seconds_per_tick, times_fired)
	metabolizer.adjustBruteLoss(-0.25 * seconds_per_tick, FALSE)
	metabolizer.adjustFireLoss(-0.25 * seconds_per_tick, FALSE)
	metabolizer.adjustToxLoss(-0.25 * seconds_per_tick, FALSE)
	metabolizer.adjustOxyLoss(-0.25 * seconds_per_tick, FALSE)
	if(metabolizer.nutrition && (metabolizer.nutrition - 2 > 0))
		metabolizer.adjust_nutrition(-0.5 * seconds_per_tick)
	..()
	return TRUE
