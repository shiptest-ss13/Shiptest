...
/datum/reagent/medicine/charcoal/on_hydroponics_apply(obj/item/seeds/myseed, datum/reagents/chems, obj/machinery/hydroponics/mytray, mob/user)
	. = ..()
...
/datum/reagent/medicine/earthsblood/on_hydroponics_apply(obj/item/seeds/myseed, datum/reagents/chems, obj/machinery/hydroponics/mytray, mob/user)
	. = ..()
	mytray.self_sufficiency_progress += chems.get_reagent_amount(/datum/reagent/medicine/earthsblood)
	if(mytray.self_sufficiency_progress >= mytray.self_sufficiency_req)
		...
		to_chat(user, "<span class='notice'>[mytray] warms as it might on a spring day under a genuine Sun.</span>")
