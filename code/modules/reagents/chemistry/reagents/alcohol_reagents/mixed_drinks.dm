...
/datum/reagent/consumable/ethanol/eudamonia/overdose_process(mob/living/M)
	...
	if(prob(8) && iscarbon(M))
		...
		to_chat(M, pick("Your head aches as you struggle to grasp the concepts.", "The world slows down for a precious second, a headache forming within you.", "Clusters of pain open and close within your mind's eye.", "Aches and pains fill your head."))
	else if(prob(50))
