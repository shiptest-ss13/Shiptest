...
/proc/make_datum_references_lists()
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/ipc_marker, GLOB.ipc_marker_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/phorid_marker, GLOB.phorid_marker_list)
